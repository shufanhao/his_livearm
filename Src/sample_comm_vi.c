...
VI_VSYNC_FIELD, VI_VSYNC_NEG_HIGH, VI_HSYNC_VALID_SINGNAL, VI_HSYNC_NEG_HIGH,
...
{
/*port_vsync   port_vsync_neg     port_hsync        port_hsync_neg        */
VI_VSYNC_PULSE, VI_VSYNC_NEG_HIGH, VI_HSYNC_VALID_SINGNAL, VI_HSYNC_NEG_HIGH,
		VI_VSYNC_VALID_SINGAL, VI_VSYNC_VALID_NEG_HIGH,
...
HI_S32 SAMPLE_TW2865_CfgV(VIDEO_NORM_E enVideoMode, VI_WORK_MODE_E enWorkMode) {
	...
	video_mode =
			(VIDEO_ENCODING_MODE_PAL == enVideoMode) ? TW2865_PAL : TW2865_NTSC;
...
HI_S32 SAMPLE_COMM_VI_GetVFrameFromYUV(FILE *pYUVFile, HI_U32 u32Width,
	...
	SAMPLE_COMM_VI_ReadFrame(pYUVFile, pstVFrameInfo->stVFrame.pVirAddr[0],
			...
			pstVFrameInfo->stVFrame.pVirAddr[2],
	...
	SAMPLE_COMM_VI_PlanToSemi(pstVFrameInfo->stVFrame.pVirAddr[0],
			pstVFrameInfo->stVFrame.u32Stride[0],
			pstVFrameInfo->stVFrame.pVirAddr[1],
