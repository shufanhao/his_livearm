...
HI_U32 SAMPLE_COMM_SYS_CalcHistVbBlkSize(VIDEO_NORM_E enNorm,
	...
	SAMPLE_PRT(
			...
			stPicSize.u32Width, pstHistBlkSize->u32Width, stPicSize.u32Height,
			pstHistBlkSize->u32Height);
	return (CEILING_2_POWER(44, u32AlignWidth)
...
HI_U32 SAMPLE_COMM_SYS_CalcPicVbBlkSize(VIDEO_NORM_E enNorm,
	...
	if (PIXEL_FORMAT_YUV_SEMIPLANAR_422 != enPixFmt
			&& PIXEL_FORMAT_YUV_SEMIPLANAR_420 != enPixFmt) {
